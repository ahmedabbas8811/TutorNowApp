            ...
            children: [
              ...
              Obx(() {
                ...
                return BookingSwipeView(
                  cards: bookingController.bookings.map((booking) {
                    return BookingCard(
                      name: booking.tutorName, // Tutor Name from DB
                      tutorImage:
                          booking.tutorImage, // Tutor Profile Image from DB
                      package: booking.packageName, // Package Name from DB
...
// 🔹 BookingCard (Displays Dynamic Tutor & Package Details)
class BookingCard extends StatelessWidget {
  final String name;
  final String package;
