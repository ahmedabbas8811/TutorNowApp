              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: const [
                      BoxShadow(color: Colors.black12, blurRadius: 0, spreadRadius: 1),
                    ],
                  ),
                  child: ListTile(
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    title: const Text('Approve Tutors', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ApproveTutorsScreen()));
                    },
                  ),
                ),
                const SizedBox(height: 8),
                Container(
                  ...
                  child: ListTile(
                    ...
                    title: const Text('Manage Users', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    onTap: () {},
                  ),
                ),
              ],
            ...
            child: Column(
              ...
              children: [
                const Padding(
                  ...
                  child: Row(
                    children: [
                      Text('Manage Users', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                      Spacer(),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      // Header Row (Green)
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 12), // 👈 Prevent edges from touching
                        child: Container(
                          height: 50,
                          decoration: BoxDecoration(
                            color: const Color(0xff87e64c),
                          ...
                          child: const Row(
                            children: [
                              ...
                              Expanded(child: SizedBox()), // No header text for message
                            ],
                          ),
                        ),
                      ),
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            padding: const EdgeInsets.symmetric(vertical: 6, horizontal: 12), // 👈 Tighter vertical spacing
                            child: Row(
                              children: [
                                const Expanded(
                                  child: Align(
                                    alignment: Alignment.center,
                                    child: Text('Bilal Jan', style: TextStyle(fontSize: 14)),
                                  ),
                                ),
                                const Expanded(
                                  child: Align(
                                    alignment: Alignment.center,
                                    child: Text('7982731023091', style: TextStyle(fontSize: 14)),
                                  ),
                                ),
                                const Expanded(
                                  child: Align(
                                    alignment: Alignment.center,
                                    child: Text('ahmerbilaljan@gmail.com', style: TextStyle(fontSize: 14)),
                                  ),
                                ),
                                const Expanded(
                                  child: Align(
                                    alignment: Alignment.center,
                                    child: Text('Parent', style: TextStyle(fontSize: 14)),
                                  ),
                                ),
                                Expanded(
                                  child: Center(
