        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: Text('Change Password', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
            ),
            const Text('Confirm Current Password', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
              ...
              decoration: InputDecoration(
                ...
                labelStyle: TextStyle(
                  color: _currentPasswordController.text.isNotEmpty
                      ? Colors.grey
                      : (_currentPasswordFocusNode.hasFocus ? Colors.grey : Colors.black),
                ),
            ...
            const Row(
              ...
              children: [
                Text("Enter New Password", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
              ],
            ),
            const SizedBox(height: 20),
            // New Password Field
              ...
              decoration: InputDecoration(
                ...
                labelStyle: TextStyle(
                  color: _newPasswordController.text.isNotEmpty
                      ? Colors.grey
                      : (_newPasswordFocusNode.hasFocus ? Colors.grey : Colors.black),
                ),
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10.0),
                  borderSide: BorderSide(color: Colors.grey),
              ...
              decoration: InputDecoration(
                ...
                labelStyle: TextStyle(
                  color: _retypePasswordController.text.isNotEmpty
                      ? Colors.grey
                      : (_retypePasswordFocusNode.hasFocus ? Colors.grey : Colors.black),
                ),
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(10.0),
                  borderSide: BorderSide(color: Colors.grey),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                padding: const EdgeInsets.symmetric(vertical: 12,horizontal: 142),
